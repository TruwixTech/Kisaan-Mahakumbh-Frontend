...
function Header() {
  return (
    <div className='w-full h-auto px-5 flex justify-between md:px-10 lg:px-14 fixed top-0 z-40'>
      ...
      <div className='w-auto h-20 flex justify-between items-center lg:gap-6 lg:h-28 xl:gap-10'>
        ...
        <div className='hidden gap-6 lg:flex xl:gap-10'>
          <NavLink to="/" className="text-black text-2xl font-semibold">Home</NavLink>
          <NavLink to="/" className="text-black text-2xl font-semibold">About Us</NavLink>
          <NavLink to="/" className="text-black text-2xl font-semibold">Events</NavLink>
          <NavLink to="/" className="text-black text-2xl font-semibold">News</NavLink>
          <NavLink to="/" className="text-black text-2xl font-semibold">Contact</NavLink>
        </div>
