    ...
    return (
        isOpen && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 font-[Roboto]">
                {/* Popup Container */}
                <div className="bg-[#01210f] p-8 rounded-2xl shadow-lg w-full max-w-6xl h-[80vh] relative border-3 border-[#374836] overflow-y-auto flex flex-col" style={{
                  ...
                  backgroundSize: 'contain'
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center">
                        {/* Content Grid */}
                        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4 w-full max-w-5xl mx-auto'>
                            {data.map((item) => (
