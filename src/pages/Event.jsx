  ...
  return (
    <div>
      ...
      <div className="w-full h-auto flex flex-col bg-[#e7e7e7] px-2 md:px-12 lg:px-12    ">
        <div>
          <h1 className="text-center text-2xl font-bold sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-[Roboto] mt-8 mb-6">
            Event
          </h1>
        ...
        <div className="w-full flex  flex-col   md:py-8 py-3 px-2 md:px-0">
          <h1 className="text-[#374836] text-xl md:text-[36px] mt-8 md:mt-0">
            {" "}
            | Events |
          </h1>
          <span className="text-[#374836] text-3xl md:text-[52px] font-[Roboto] mt-4 md:mt-0">
        ...
        <div className=" w-full h-auto p-2 md:p-6 bg-white rounded-3xl mb-7 ">
          <div className="   px-2 md:px-12 lg:px-12 ">
            <h1 className="text-4xl font-bold text-gray-800 my-6 font-[Roboto] flex flex-col justify-center items-center lg:justify-start md:items-start ">
              THEME 1
            </h1>
            {/* First session */}
            {sessions.map((session, index) => (
              <div
                key={index}
                className="w-full mb-6 flex flex-col items-center lg:flex-row lg:items-start  gap-5"
              >
                    ...
                    {session.details.map((detail, i) => (
                      ...
                      >
                        ...
                        <div className="flex gap-5">
                          <span className=" w-full text-gray-400 text-[20px] font-[Roboto]">
                            {detail.speaker}
                          </span>
                        </div>
                      </div>
        ...
        <div className=" w-full h-auto p-2 md:p-6 bg-white rounded-3xl mb-7 ">
          <div className=" px-4 md:px-12 lg:px-12 ">
            ...
            {theme2.map((theme2, index) => (
              <div
                key={index}
                className="mb-6 flex flex-col items-center lg:flex-row lg:items-start  gap-5"
              >
                <div className="w-full flex justify-center lg:justify-start md:w-[20%]">
                  <p className="text-4xl font-semibold text-gray-700 ">
                    {theme2.time}
        ...
        <div className=" w-full h-auto p-6 bg-white rounded-3xl mb-7 ">
          <div className=" px-2 md:px-12 lg:px-12 ">
            <h1 className="text-4xl font-bold text-gray-800 my-6 font-[Roboto] flex flex-col justify-center items-center md:justify-start md:items-start">
              THEME 6
            </h1>
            {/* First session */}
