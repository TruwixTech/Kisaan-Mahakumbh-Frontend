  ...
  return (
    <div>
      ...
      <div className='w-full h-auto flex flex-col bg-[#e7e7e7] px-2 md:px-12 lg:px-12    '>
        <div >
          <h1 className='text-center text-2xl font-bold sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-[Roboto] mt-8'>Event</h1>
        ...
        <div className=' w-full h-auto p-2 md:p-6 bg-white rounded-3xl mb-7 '>
          {sessions.map((session, index) => (
            <div key={index} className="px-2 md:px-12 lg:px-12 ">
              ...
              <h1 className="text-2xl md:text-4xl font-bold text-gray-800 mb-3 md:mb-6 font-[Roboto] flex flex-col justify-center items-center lg:justify-start md:items-start ">{session.theme}</h1>
              {/* First session */}
        ...
        <div className=' w-full h-auto p-2 md:p-6 bg-white rounded-3xl '>
          {sessions2.map((session2, index) => (
            <div key={index} className="   px-2 md:px-12 lg:px-12 ">
              ...
              <h1 className="text-2xl md:text-4xl font-bold text-gray-800 mb-6 font-[Roboto] flex flex-col justify-center items-center lg:justify-start md:items-start ">{session2.theme}</h1>
              {/* First session */}
