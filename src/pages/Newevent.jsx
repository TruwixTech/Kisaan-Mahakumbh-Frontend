    ...
    return (
        <>
            ...
            <div className='w-full h-auto flex flex-col bg-[#e7e7e7]'>
                ...
                <div >
                    <h1 className='font-[Roboto] w-full h-auto flex flex-col px-5 md:px-10 lg:px-20 pt-16  bg-[#e7e7e7] md:gap-2  text-[30px]  md:text-[75.48px] items-center'>News About Event</h1>
